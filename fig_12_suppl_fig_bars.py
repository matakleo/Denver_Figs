...
fig = plt.figure(figsize=(14.5, 3.3))
...
ysu_intensities_lvls,ysu_track_lvls,ysu_slp_lvls,wind_percentile_ysu_lvls,track_percentile_ysu_lvls, slp_percentile_ysu_lvls, avg_def_pblh = gimme_errors_tribars_fixes_HBLS('YSU')

BarWidth=0
column_width=2.5
LVLS=['HBL = 250m','Default Case, HBL = '+str(int(avg_def_pblh))+'m','HBL = 1000m']
...
ax2.set_ylabel(r'$MAE_{track}$ (km)',fontsize=12, labelpad=0.001)
ax3.set_ylabel(r'$MAE_{SLP}$ (mb)',fontsize=12)
...
# plt.show()
print('fig saved as fig12_supplement.eps')
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig12_supplement.eps',bbox_inches='tight')