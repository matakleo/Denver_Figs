...
dirs=['Reduced_PBL','Default']
label_names=['Reduced PBL Depth','Default PBL Depth']
dir_num=0
i=0
file_in_dir=0
height_lvl=0
...
#     for idx in range(0,1):
        ...
        for dir in dirs:
            ...
            ax[0].annotate(r'INTENSIFICATION', xy=(-80,17), xytext=(+40,+20),
            textcoords='offset points', ha='center', va='center', size=32,
             color='white',
            ...
            vmin_set=0
            if dir=='Default' and total_wind.max()>40:
                vmax_set=total_wind.max()+3
            else:
                vmax_set=40
        ...
        print('saved fig number ',file_num,idx)
        break
    break
