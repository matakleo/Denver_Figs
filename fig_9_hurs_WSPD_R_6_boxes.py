...
CLS = ['lz_0p0001','lz_0p0100','lz_1p0000']
plot_order = [0,3,1]
fig_name='_lvls_'
...
for PBL in PBLS:
    ...
    for HN in HNS :
        ...
        Input_Dir_1 = Input_Dir + '/WSPD_R/' + HN+'/'
        ...
        for CL in CLS:
                ...
                Hurricane_Setting = 'WRFONLY_NoTurb_8km_isftcflx_1_changeC'+CL +'.csv'		
                ...
                ax[row_count,col_count].plot(rads[0:40], WSPD[0:40], color=colors[cls_counter],  linestyle='-',
                marker='x', markersize='0',  
                    linewidth='3', label= CL,zorder=plot_order[cls_counter])
...
# plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig9_wspd_r_boxes'+fig_name+'.eps',bbox_inches='tight')
