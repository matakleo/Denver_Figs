...
# labelxx=
ax1.set_ylabel(r'$MAPE_{ intensity }$(\,\%) \,',fontsize=size)
ax2.set_ylabel(r'$MAE_{ track }$(\,km) \,',fontsize=size)

xticks=[0.15,1.15,2.15]
ax1.set_xticks(xticks)
ax2.set_xticks(xticks)
ax1.set_xticklabels(GSS,size=size)
...
# plt.show()
plt.savefig('/Users/lmatak/Desktop/leo_python_scripts/Paper_Figs/figs_saved/fig2_grid_sensitivity.eps',bbox_inches='tight')