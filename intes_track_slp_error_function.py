...
def radius_of_max_wind_xkzm(PBL):
    ...
    PBLS = PBL
    final_out_list=[]
    CLS= ['xkzm_0.2','1.0_xkzm','xkzm_5.0']
    if PBL == 'MYJ':
        CLS = ['km_0.2','1.0_xkzm','km_5.0']
...
def gimme_errors_tribars_fixes_HBLS(PBL):
    ...
    for GS in GSS:
        ...
        for HN in HNS:
            ...
            #get the default PBLH for YSU unodified#
            Default_PBLH=[]
            Default_PBLH= Extract_by_name(csv_files[1],Default_PBLH,'PBLH')
            # print('Default pbl = ',np.average(Default_PBLH[1:]))
            Default_PBLHS_list.append(np.average(Default_PBLH[1:]))
        ...
        # print('track_percentile for grafs',track_percentile)
        # print('track 80',track_percentile)
        Avg_of_avg_pblhs=np.average(Default_PBLHS_list)
    return(list_of_wind_errors,list_of_track_errors,list_of_slp_errors,wind_percentile,track_percentile,slp_percentile,Avg_of_avg_pblhs)

gimme_errors_tribars_fixes_HBLS('YSU')
